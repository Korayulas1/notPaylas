				...
				<div class="row  mx-auto col-5">
					...
					if (isset($_POST['kayit'])) {
						...
						elseif($sifre != $sifre_tekrar){
							$hata = 'Girilen şifreler birbiri ile uyuşmuyor';
						}
						else{
							$sorgu = $db->prepare("INSERT INTO kayit SET
								email = ?,
								sifre = ?");
							...
							if ($kayit){
								$basarili = 'Kayıt Başarılı Yönlendiriliyorsunuz...';
					...
					<main class="form-signin">
						<form method="post" action="">
							...
							<label  class="visually-hidden">Şifre Tekrar</label>
							<input type="password" name="sifre_tekrar"  class="form-control" placeholder="Şifre Tekrar" required>
							<button class="w-100 btn btn-lg btn-primary" value="1" name="kayit" type="submit">Kayıt Ol</button>
						</form>
					</main>
